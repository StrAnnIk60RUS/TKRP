import { buildPostFeatureVector, buildPostFeatureVectorFromFeatureMap, POST_FEATURE_NAMES } from '../ml/ontologyFeatureEngineering.js';
import { predictPostLikesByFeatureVectors } from '../relevancePredictionService.js';
